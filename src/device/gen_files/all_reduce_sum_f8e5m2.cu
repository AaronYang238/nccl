...
#include "all_reduce.h"
    ...
    DEFINE_ncclDevKernel_nop(AllReduce_Sum_f8e5m2_RING_LL, ncclFuncAllReduce, FuncSum, __nv_fp8_e5m2, NCCL_ALGO_RING, NCCL_PROTO_LL, 287)
  #else
    DEFINE_ncclDevKernel(AllReduce_Sum_f8e5m2_RING_LL, ncclFuncAllReduce, FuncSum, __nv_fp8_e5m2, NCCL_ALGO_RING, NCCL_PROTO_LL, 287)
  #endif
#endif
#if CUDART_VERSION >= 11080
  #if __CUDA_ARCH__ < 900
    DEFINE_ncclDevKernel_nop(AllReduce_Sum_f8e5m2_TREE_LL, ncclFuncAllReduce, FuncSum, __nv_fp8_e5m2, NCCL_ALGO_TREE, NCCL_PROTO_LL, 290)
  #else
    DEFINE_ncclDevKernel(AllReduce_Sum_f8e5m2_TREE_LL, ncclFuncAllReduce, FuncSum, __nv_fp8_e5m2, NCCL_ALGO_TREE, NCCL_PROTO_LL, 290)
  #endif
#endif
