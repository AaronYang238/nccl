...
#include "all_reduce.h"
  ...
  #if __CUDA_ARCH__ < 0
    DEFINE_ncclDevKernel_nop(AllReduce_Sum_bf16_RING_LL, ncclFuncAllReduce, FuncSum, __nv_bfloat16, NCCL_ALGO_RING, NCCL_PROTO_LL, 241)
  #else
    DEFINE_ncclDevKernel(AllReduce_Sum_bf16_RING_LL, ncclFuncAllReduce, FuncSum, __nv_bfloat16, NCCL_ALGO_RING, NCCL_PROTO_LL, 241)
  #endif
#endif
#if CUDART_VERSION >= 11000
  #if __CUDA_ARCH__ < 0
    DEFINE_ncclDevKernel_nop(AllReduce_Sum_bf16_TREE_LL, ncclFuncAllReduce, FuncSum, __nv_bfloat16, NCCL_ALGO_TREE, NCCL_PROTO_LL, 244)
  #else
    DEFINE_ncclDevKernel(AllReduce_Sum_bf16_TREE_LL, ncclFuncAllReduce, FuncSum, __nv_bfloat16, NCCL_ALGO_TREE, NCCL_PROTO_LL, 244)
  #endif
#endif
