...
DEFINE_ncclDevKernel(AllReduce_Sum_f64_RING_LL, ncclFuncAllReduce, FuncSum, double, NCCL_ALGO_RING, NCCL_PROTO_LL, 271)
DEFINE_ncclDevKernel(AllReduce_Sum_f64_TREE_LL, ncclFuncAllReduce, FuncSum, double, NCCL_ALGO_TREE, NCCL_PROTO_LL, 274)
