...
#include "reduce_scatter.h"
  ...
  #if __CUDA_ARCH__ < 0
    DEFINE_ncclDevKernel_nop(ReduceScatter_Sum_bf16_RING_LL, ncclFuncReduceScatter, FuncSum, __nv_bfloat16, NCCL_ALGO_RING, NCCL_PROTO_LL, 609)
  #else
    DEFINE_ncclDevKernel(ReduceScatter_Sum_bf16_RING_LL, ncclFuncReduceScatter, FuncSum, __nv_bfloat16, NCCL_ALGO_RING, NCCL_PROTO_LL, 609)
  #endif
#endif
