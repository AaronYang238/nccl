...
#include "reduce.h"
  ...
  #if __CUDA_ARCH__ < 0
    DEFINE_ncclDevKernel_nop(Reduce_Sum_bf16_RING_LL, ncclFuncReduce, FuncSum, __nv_bfloat16, NCCL_ALGO_RING, NCCL_PROTO_LL, 429)
  #else
    DEFINE_ncclDevKernel(Reduce_Sum_bf16_RING_LL, ncclFuncReduce, FuncSum, __nv_bfloat16, NCCL_ALGO_RING, NCCL_PROTO_LL, 429)
  #endif
#endif
