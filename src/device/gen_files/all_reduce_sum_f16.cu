...
DEFINE_ncclDevKernel(AllReduce_Sum_f16_RING_LL, ncclFuncAllReduce, FuncSum, half, NCCL_ALGO_RING, NCCL_PROTO_LL, 251)
DEFINE_ncclDevKernel(AllReduce_Sum_f16_TREE_LL, ncclFuncAllReduce, FuncSum, half, NCCL_ALGO_TREE, NCCL_PROTO_LL, 254)
