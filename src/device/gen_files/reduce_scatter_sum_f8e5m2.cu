...
#include "reduce_scatter.h"
    ...
    DEFINE_ncclDevKernel_nop(ReduceScatter_Sum_f8e5m2_RING_LL, ncclFuncReduceScatter, FuncSum, __nv_fp8_e5m2, NCCL_ALGO_RING, NCCL_PROTO_LL, 637)
  #else
    DEFINE_ncclDevKernel(ReduceScatter_Sum_f8e5m2_RING_LL, ncclFuncReduceScatter, FuncSum, __nv_fp8_e5m2, NCCL_ALGO_RING, NCCL_PROTO_LL, 637)
  #endif
#endif
