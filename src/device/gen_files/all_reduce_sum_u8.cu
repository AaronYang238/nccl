...
DEFINE_ncclDevKernel(AllReduce_Sum_u8_RING_LL, ncclFuncAllReduce, FuncSum, uint8_t, NCCL_ALGO_RING, NCCL_PROTO_LL, 315)
DEFINE_ncclDevKernel(AllReduce_Sum_u8_TREE_LL, ncclFuncAllReduce, FuncSum, uint8_t, NCCL_ALGO_TREE, NCCL_PROTO_LL, 318)
