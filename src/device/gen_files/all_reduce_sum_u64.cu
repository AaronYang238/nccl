...
DEFINE_ncclDevKernel(AllReduce_Sum_u64_RING_LL, ncclFuncAllReduce, FuncSum, uint64_t, NCCL_ALGO_RING, NCCL_PROTO_LL, 307)
DEFINE_ncclDevKernel(AllReduce_Sum_u64_TREE_LL, ncclFuncAllReduce, FuncSum, uint64_t, NCCL_ALGO_TREE, NCCL_PROTO_LL, 310)
