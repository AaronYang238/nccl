...
#include "reduce.h"
    ...
    DEFINE_ncclDevKernel_nop(Reduce_Sum_f8e5m2_RING_LL, ncclFuncReduce, FuncSum, __nv_fp8_e5m2, NCCL_ALGO_RING, NCCL_PROTO_LL, 444)
  #else
    DEFINE_ncclDevKernel(Reduce_Sum_f8e5m2_RING_LL, ncclFuncReduce, FuncSum, __nv_fp8_e5m2, NCCL_ALGO_RING, NCCL_PROTO_LL, 444)
  #endif
#endif
