...
#include "reduce.h"
    ...
    DEFINE_ncclDevKernel_nop(Reduce_Sum_f8e4m3_RING_LL, ncclFuncReduce, FuncSum, __nv_fp8_e4m3, NCCL_ALGO_RING, NCCL_PROTO_LL, 441)
  #else
    DEFINE_ncclDevKernel(Reduce_Sum_f8e4m3_RING_LL, ncclFuncReduce, FuncSum, __nv_fp8_e4m3, NCCL_ALGO_RING, NCCL_PROTO_LL, 441)
  #endif
#endif
