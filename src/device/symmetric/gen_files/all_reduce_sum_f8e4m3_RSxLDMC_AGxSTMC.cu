...
#include "symmetric/all_reduce.cuh"
  ...
  __global__ void ncclSymkDevKernel_AllReduce_RSxLDMC_AGxSTMC_sum_f8e4m3(ncclSymkDevWorkArgs4K NCCL_GRID_CONSTANT const args4K) {
      ...
      ncclSymkRun_AllReduce_RSxLDMC_AGxSTMC<FuncSum, __nv_fp8_e4m3>(&args4K.args);
    #endif
  }
#endif
