...
#include "symmetric/reduce_scatter.cuh"
  ...
  __global__ void ncclSymkDevKernel_ReduceScatter_LDMC_sum_f8e5m2(ncclSymkDevWorkArgs4K NCCL_GRID_CONSTANT const args4K) {
      ...
      ncclSymkRun_ReduceScatter_LDMC<FuncSum, __nv_fp8_e5m2>(&args4K.args);
    #endif
  }
#endif
